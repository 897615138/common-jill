...
import pattern.proxy.dynamicproxy.gpproxy.GPClassLoader;
import pattern.proxy.dynamicproxy.gpproxy.GPInvocationHandler;
import pattern.proxy.dynamicproxy.gpproxy.GPProxy;
